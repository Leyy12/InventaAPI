...
export default function DocsPage() {
  return <div className="w-full px-6 lg:px-8 pb-10 space-y-6 text-slate-300">
    ...
    <section className="glass-card rounded-xl border border-slate-700 p-6 space-y-3">
      ...
      <p>Optional parameters: <code>q</code> (or <code>search</code>) searches product text; <code>page</code> is a positive page number; <code>perPage</code> is the requested page size. Free catalog pages are capped at 50 products. Page size is not the request allowance. Follow returned <code>meta.pagination</code> when present; empty results may omit pagination.</p>
