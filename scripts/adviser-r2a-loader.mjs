...
const modules = new Set(["services/product-submission-contract.js","services/product-submissions.js","services/product-contract.js","functions/subscription-lifecycle.mjs","tests/adviser/r2a/memory-firestore.mjs","tests/adviser/r2a/submissions.test.mjs","tests/adviser/r2a/wiring.test.mjs","dashboard/src/lib/product-image-url.ts","admin-panel/src/lib/product-image-url.ts","admin-panel/src/lib/submission-review.ts","tests/adviser/r2a/review-ui.test.mjs"].map(file => resolvePath(root, file)));
